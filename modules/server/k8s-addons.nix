...
let
  ...
  # ── metrics-server manifest（内嵌，避免 GitHub release URL 变动）──
  metricsServerManifest = pkgs.writeText "metrics-server.yaml" ''
    apiVersion: v1
    kind: ServiceAccount
    metadata:
      labels:
      ...
      template:
        ...
        spec:
          ...
          - args:
            ...
            image: registry.k8s.io/metrics-server/metrics-server:v0.8.4
  ...
  metricsServerPatched = metricsServerManifest;
